...
#### 🎯 **8.1 프로젝트 상세 페이지 메뉴 구조 개선**
- [ ] 프로젝트 문서와 팀멤버 사이에 "사전 분석" 섹션 추가
- [ ] 사전 분석 진행 상황 표시 위젯 구현
- [ ] 빠른 액션 메뉴 재구성 (사전 분석, 라이프사이클 관리, 분석 보고서 명확히 구분)
- [ ] 메뉴 아이콘 및 설명 개선
